...
class IngridientRecyclerViewAdapter : RecyclerView.Adapter<IngridientViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IngridientViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.view_holder_meal, parent, false)
        return IngridientViewHolder(view)
    }

    override fun onBindViewHolder(holder: IngridientViewHolder, position: Int) {
...
class IngridientViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
